 ...
 */
final class Version20210828092637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE agent_type_id_seq CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE agent_type_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE agent_type (id INT NOT NULL, code VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
}
